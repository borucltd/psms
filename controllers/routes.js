...
router.get('/my-playlists', ensureAuthenticated, function(req, res) {
  res.render('my-playlists', { user: req.user });
});

router.get('/journal', ensureAuthenticated, function(req, res) {
