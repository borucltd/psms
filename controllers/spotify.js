...
// Display Filterd Playlists From Database

router.get('/local/search_for_playlists',   async (req,res) => {
    ...
    //     // if (obj.title == search || obj.artist == search) {
    ...
    res.render('testing', { user: req.user, localdb_tracks:  tracks });
});
